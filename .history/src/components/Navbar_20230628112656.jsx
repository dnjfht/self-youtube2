  ...
  return (
    ...
    >
      <div className="w-10/12 h-[100%] mx-auto flex items-center justify-between">
        ...
        >
          <input
            className="w-5/6 h-[50px] p-3 box-border rounded-l-full bg-transparent border-[2px] border-solid border-[#7b5b51] placeholder:text-[#845648] outline-none text-[#41261e]"
            type="text"
            value={text}
        ...
        {/* darkMode button */}
        <button
          className="w-[50px] h-[50px] bg-[#3f241b] rounded-full text-[1.4rem] text-white flex justify-center items-center font-light"
