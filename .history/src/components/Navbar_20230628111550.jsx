  ...
  return (
    ...
    >
      <div className="w-10/12 h-[100%] mx-auto flex items-center justify-between">
        ...
        {/* 검색창 input */}
        <form
          className="w-6/12 h-[70px] my-3 flex items-center"
          onSubmit={handleSearchKeyword}
        >
          <input
            className="w-5/6 p-3 rounded-l-full bg-transparent border-[2px] border-solid border-[#7b5b51]"
            type="text"
            value={text}
          ...
          <button
            type="submit"
            className="p-3 rounded-r-full border-[2px] border-solid border-[#7b5b51]"
          >
            <CiSearch />
          </button>
        </form>
