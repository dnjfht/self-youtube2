      ...
      <div className="w-10/12 h-[100%] mx-auto flex items-center justify-between">
        ...
        >
          <input
            className={`${
              darkMode
                ? "border-[#f0e6e0a7] placeholder:text-[#d5cbc6a7]"
                : "border-[#7b5b51] placeholder:text-[#845648]"
            } w-5/6 h-[50px] p-3 box-border rounded-l-full bg-transparent border-[2px] border-solid outline-none text-[#41261e]`}
            type="text"
            value={text}
