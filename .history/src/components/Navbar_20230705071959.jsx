      ...
      <div className="w-10/12 h-[100%] mx-auto flex items-center justify-between">
        ...
        >
          <input
            className={`${
              focusOn
                ? "w-[94%] border-[#3d39b2] placeholder:text-[#3d39b2]"
                : darkMode && !focusOn
                ? "border-[white] w-[86%] placeholder:text-[#fbf9f8ae] text-[#ffffff]"
                : "w-[86%] border-[#7b5b51] placeholder:text-[#845648] text-[#41261e]"
