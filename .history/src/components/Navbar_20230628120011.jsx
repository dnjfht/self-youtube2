      ...
      <div className="w-10/12 h-[100%] mx-auto flex items-center justify-between">
        ...
        >
          <input
            ...
            } w-10/12 h-[50px] p-3 box-border rounded-l-full bg-transparent border-[2px] border-solid outline-none`}
            type="text"
            value={text}
          ...
          <button
            ...
            } w-2/12 h-[50px] py-3 rounded-r-full border-r-[2px] border-y-[2px] border-solid text-[1.4rem] flex items-center justify-center`}
          >
            <CiSearch />
          </button>
        </form>
