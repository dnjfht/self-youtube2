    ...
    >
      <div className="w-10/12 h-[100%] mx-auto flex items-center justify-between">
        ...
        >
          <input
            className={`${
              darkMode ? "border-[#f0e6e0a7]" : "border-[#7b5b51]"
          ...
          <button
            ...
            className={`${
              darkMode
                ? "border-[#f0e6e0a7] bg-[#f0e6e0a7]"
                : "border-[#7b5b51] bg-[#3f241b]"
            } h-[50px] py-3 px-6 rounded-r-full border-r-[2px] border-y-[2px] border-solid text-white text-[1.4rem] flex items-center justify-center`}
          >
            <CiSearch />
          </button>
        </form>
