  ...
  return (
    ...
    >
      <div className="w-10/12 h-[100%] mx-auto flex items-center justify-between">
        ...
        >
          <input
            className="w-5/6 h-[50px] p-3 box-border rounded-l-full bg-transparent border-[2px] border-solid border-[#7b5b51] placeholder:text-[#583429]"
            type="text"
            value={text}
          ...
          <button
            type="submit"
            className="h-[50px] py-3 px-6 rounded-r-full border-[2px] border-solid border-[#7b5b51]"
          >
            <CiSearch />
          </button>
        </form>
